...
App::App(int argc, char** argv, int width, int height, const char* title): GlutApp(argc, argv, width, height, title){
    ...
    enemies.push_back(new Knight(idleSprite, runSprite, new Hitbox(-0.2, -0.3, 0.2, 0.2), -0.2, -0.3, 0.2, 0.2, 0.8f, 0.8f));
    ...
    enemies.push_back(new Drone(idleSprite, runSprite, new Hitbox(-0.2, 0.3, 0.2, 0.2), -0.2, 0.3,  0.2, 0.2, 0.6, 0.4));
